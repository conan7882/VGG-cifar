...
```
The pre-trained ID is epoch ID shown in the save modeled file name. The default value is `104`, which indicates the one I uploaded. The output will be the accuracy of training and testing set.
